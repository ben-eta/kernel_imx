...
#define SABRESD_PCIE_WAKE_B	IMX_GPIO_NR(1, 27)
...
/*reboot -p*/
#define MCU_P01 	        IMX_GPIO_NR(4, 5)
...
static struct mxc_audio_platform_data mxc_sgtl5000_data;
...
/* [ZCL],Rev20151218,cancel the i2c device
	{
...
static struct platform_pwm_backlight_data mx6_sabresd_pwm2_backlight_data = {
	.pwm_id = 1,
	.max_brightness = 248,
	.dft_brightness = 128,
	.pwm_period_ns = 50000,
...
static struct platform_pwm_backlight_data mx6_sabresd_pwm3_backlight_data = {
        .pwm_id = 2,
        .max_brightness = 248,
        .dft_brightness = 128,
        .pwm_period_ns = 50000,
...
{
	printk("system_poweroff...1");
	gpio_direction_output(MCU_P01, 0);
	mdelay(150);
}

void system_reboot(void)
{
        printk("system_reboot...1");
        gpio_direction_output(MCU_P01, 0);
...
int lvds_power_en(struct platform_device *pdev)
{
	msleep(4000);
...
*/
	...
	*/
	...
	imx6q_add_mxc_pwm_backlight(0, &mx6_sabresd_pwm1_backlight_data);
	imx6q_add_mxc_pwm_backlight(1, &mx6_sabresd_pwm2_backlight_data);
    imx6q_add_mxc_pwm_backlight(2, &mx6_sabresd_pwm3_backlight_data);
