...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(LONGCHEER_VENDOR_ID, 0x9b05) },
	...
	/*[ZCL],rev20160720,add VID and PID of Quectel LTE modem*/
	#if 1
	{ USB_DEVICE(0x05C6, 0x9090) },   /* For Quectel UC15 */
	{ USB_DEVICE(0x05C6, 0x9003) },   /* For Quectel UC20 */
	{ USB_DEVICE(0x05C6, 0x9215) },   /* For Quectel EC20(V1.0) */
	{ USB_DEVICE(0x2C7C, 0x0125) },   /* For Quectel EC20(V2.0) and EC25 */
